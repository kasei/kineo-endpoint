...
let package = Package(
    ...
    dependencies: [
       .package(name: "Kineo", url: "https://github.com/kasei/kineo.git", .upToNextMinor(from: "0.0.92")),
//        .package(name: "Kineo", url: "https://github.com/kasei/kineo.git", .branch("sparql-12")),
       ...
       .package(name: "Diomede", url: "https://github.com/kasei/diomede.git", .upToNextMinor(from: "0.0.46")),
